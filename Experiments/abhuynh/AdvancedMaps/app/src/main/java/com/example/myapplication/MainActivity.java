...
public class MainActivity extends AppCompatActivity {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        this.map.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                View infoWindow = getLayoutInflater().inflate(R.layout.activity_ongoing_trip_details,
                        (FrameLayout) findViewById(R.id.map), false);

                TextView title = infoWindow.findViewById(R.id.trip_title);
                title.setText(marker.getTitle());

                TextView snippet = infoWindow.findViewById(R.id.trip_snippet);
    ...
    private void showCurrentPlace() {
        ...
        if (locationPermissionGranted) {
            ...
            // Default marker
            map.addMarker(new MarkerOptions().title("Title").position(defaultLocation).snippet("Snippet"));
            getLocationPermission();
        }
    }
